...
//   return (
//     <div
//       className={`relative rounded-2xl p-8 backdrop-blur-xl bg-white/5 border transition-all
//       ${
//         popular
//           ? "border-indigo-500 shadow-indigo-500/30 shadow-2xl scale-105"
//           : "border-white/10"
//       }`}
//     >
//       {/* Popular badge */}
//       {popular && (
//         <span className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-indigo-500 to-pink-500 px-4 py-1 rounded-full text-sm font-semibold">
//           MOST POPULAR
//         </span>
//       )}
...
//         {subtitle && (
//           <span className="text-gray-400 text-lg ml-1">{subtitle}</span>
//         )}
//       </div>
